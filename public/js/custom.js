...
$(document).ready(function(){
   ...
   /*$(".subscribebutton").on('click',function(e){
   		if ($("#subscribe-email").val()!="") {
   			$(".subscriberror").text("Thank you for subscribing to our newsletter!");
   			$(".subscriberror").removeClass("hide");
   		} 
   		else $(".subscriberror").removeClass("hide");
   });
   $("#subscribe-email").on("keypress",function(event) {if(event.keyCode == 13) $(".subscribebutton").click();});*/
   return false;
});
